...
public class OrdenService {
    ...
    public Page<Orden> getMyOrders(Long orderId, Integer cantidad, Long globalId,Long pedidoId, String materialName, EstadoOrden estado, LocalDate fechaOrden, LocalDate lastUpdate, int page, int pageSize) throws CentroInvalidoException {
        return ordenRepository.findMyOrders(orderId,cantidad, globalId,this.centroService.recuperarCentro().getId(),pedidoId, materialName, estado, fechaOrden,lastUpdate, PageRequest.of(page, pageSize));
    }
