...
public class MaterialController {
    ...
    public ResponseEntity<?> editarMaterial(@PathVariable Long id, @RequestBody MaterialDTO materialDTO) {
        try {
            Material materialActualizado = materialService.editarMaterial(id, materialDTO);
    ...
    public ResponseEntity<Map<String, Object>> eliminarMaterial(@PathVariable Long id) {
